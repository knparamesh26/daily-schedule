...
export default function TaskForm({ task, defaultPriority = 'medium', projects = [], onSave, onCancel }: Props) {
  const [form, setForm] = useState(EMPTY_FORM);

  useEffect(() => {
    if (task) setForm(task);
    else setForm({ ...EMPTY_FORM, priority: defaultPriority });
        ...
        <div className="col-span-12 lg:col-span-8 space-y-lg">
          <div className="bg-surface-container-lowest border border-outline-variant p-xl rounded-xl shadow-sm">
            <div className="space-y-xl">
              ...
              <div>
                <label className="block text-label-md text-on-surface mb-sm" htmlFor="description">
                  Description
                </label>
                <textarea
                  id="description"
        ...
        <div className="col-span-12 lg:col-span-4 space-y-lg">
          <div className="bg-surface-container-lowest border border-outline-variant p-xl rounded-xl shadow-sm">
            <div className="space-y-xl">
              {/* Status */}
              <div>
                <label className="block text-label-md text-on-surface mb-sm" htmlFor="status">
                  Status
                </label>
                <div className="relative">
                  ...
                  <select
                    id="status"
                    className="w-full pl-[48px] pr-md py-md bg-surface-container-lowest border border-outline-variant rounded-lg focus:ring-2 focus:ring-secondary focus:border-transparent text-body-md outline-none transition-all appearance-none"
                    value={form.status}
              ...
              {/* Priority */}
              <div>
                <label className="block text-label-md text-on-surface mb-sm" htmlFor="priority">
                  Priority
                </label>
                <div className="relative">
                  <span className="material-symbols-outlined absolute left-md top-1/2 -translate-y-1/2 text-on-surface-variant pointer-events-none">
              ...
              {/* Due date */}
              <div>
                <label className="block text-label-md text-on-surface mb-sm" htmlFor="due-date">
                  Due Date
                </label>
                <div className="relative">
                  <span className="material-symbols-outlined absolute left-md top-1/2 -translate-y-1/2 text-on-surface-variant pointer-events-none">
                  ...
                  <input
                    id="due-date"
                    type="date"
                    className="w-full pl-[48px] pr-md py-md bg-surface-container-lowest border border-outline-variant rounded-lg focus:ring-2 focus:ring-secondary focus:border-transparent text-body-md outline-none transition-all"
                    value={form.dueDate}
              ...
              {/* Start date */}
              <div>
                <label className="block text-label-md text-on-surface mb-sm" htmlFor="start-date">
                  Start Date
                </label>
                <div className="relative">
                  <span className="material-symbols-outlined absolute left-md top-1/2 -translate-y-1/2 text-on-surface-variant pointer-events-none">
              ...
              {/* Project */}
              <div>
                <label className="block text-label-md text-on-surface mb-sm" htmlFor="project">
                  Project
                </label>
                <div className="relative">
                  <span className="material-symbols-outlined absolute left-md top-1/2 -translate-y-1/2 text-on-surface-variant pointer-events-none">
